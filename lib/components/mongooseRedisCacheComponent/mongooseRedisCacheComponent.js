...
module.exports = MongooseRedisCacheComponent;
...
function MongooseRedisCacheComponent(sid, opts) {
    ...
    this.$id = "mongooseRedisCacheComponent";
    this.$init =  "init";
...
MongooseRedisCacheComponent.prototype.init = function () {
    ...
    this.opts["path"] = Path.normalize(this.$application.workedir + "/app/" + this.sid);
    ...
    this.$application.set('redisClient', client);

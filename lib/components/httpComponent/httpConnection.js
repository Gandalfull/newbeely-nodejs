 ...
 * @constructor
 */
function Connection(cid, socket, protocols) {
    EventEmitter.call(this);

    this.$id = "httpConnection";
    ...
    Logger.info("New connection " + cid + " from " + (socket.connection ? socket.connection.remoteAddress : "unknown"));
}
